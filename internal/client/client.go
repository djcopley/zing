...
func newPlaintextClient(address string) (*Client, error) {
...
func newTLSClient(address string, insecure bool) (*Client, error) {
...
func NewClient(address string, insecure, plaintext bool) (*Client, error) {
	if plaintext {
		return newPlaintextClient(address)
	}
	return newTLSClient(address, insecure)
}
